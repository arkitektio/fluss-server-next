...
class BindsInput:
    implementations: Optional[list[str]] = strawberry.field(
        default=None,
        description="The implementations that are needed to run the dependency. This is used to create a dependency graph for the implementation",
    )
    clients: Optional[list[str]] = strawberry.field(
        default=None,
        description="The clients that are needed to run the dependency. This is used to create a dependency graph for the implementation",
    )
