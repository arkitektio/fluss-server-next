...
class Message(models.Model):
    ...
    is_streaming = models.BooleanField(default=False, help_text="Is the message currently streaming? Will mark it as streaming on the webinterface")
    attached_structures = models.ManyToManyField(Structure, help_text="Does this message ")
